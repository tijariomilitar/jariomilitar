...
Sale.view.show = (sale) => {
	...
	sale.billet_url && sale_info_div.appendChild(lib.element.icon('b7', 30, "/images/icon/billet.png", `lib.openExternalLink('${sale.billet_url}')`));
	...
	sale.box_amount && sale_info_div.appendChild(lib.element.info("b4 em09", "Volumes", `${sale.box_amount || ''}`));
